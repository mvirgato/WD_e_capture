...
double integrandCollEff(double r, double Ep, double sp, double tp, double muFe, double nE, double B, double mchi, int oper, double z0, double k0)
{
    // full integrand
    // The input integration variables are those transformed to the unit hyperbube
...
double monteIntegrandCollEff(double x[], size_t dim, void *p)
{
    (void)(dim);
